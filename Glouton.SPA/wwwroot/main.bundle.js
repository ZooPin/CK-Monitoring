...
var LogSearcherService = (function () {
    ...
    LogSearcherService.prototype.GetAll = function (maxLogToReturn) {
...
var LogSearcherComponent = (function () {
    ...
    LogSearcherComponent.prototype.GetAll = function (maxLogToReturn) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.LogSearcherService.GetAll(maxLogToReturn).subscribe(function (data) { return _this.data = data; })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
